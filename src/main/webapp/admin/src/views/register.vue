    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">校园一卡通密钥管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="联系方式" class="input" v-if="tableName=='xuesheng'">
                            <el-input v-model="ruleForm.xueshengPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
                        ...
                        <el-form-item label="工作人员姓名" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuName" autocomplete="off" placeholder="工作人员姓名"  />
                        </el-form-item>
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/xiaoyuanyikatongmiyaoguanli/img/back-img-bg.jpg);
