        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="xueshengPhone">
                       <el-input v-model="ruleForm.xueshengPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.xueshengPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="学校" prop="xuexiaoTypes">
                        <el-select v-model="ruleForm.xuexiaoTypes" :disabled="ro.xuexiaoTypes" placeholder="请选择学校">
                            <el-option
